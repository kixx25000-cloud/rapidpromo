...
const CATEGORY_INTRO: Record<string, string> = {
  ...
  "bricolage": `Perceuses, visserie, peinture, outillage électroportatif, quincaillerie... la catégorie bricolage de RapidPromo réunit les meilleures promotions repérées chez nos marchands partenaires. Chaque fiche produit affiche le prix le plus bas actuellement disponible, la réduction appliquée par rapport au prix de référence et, quand elle est connue, la date de fin de l'offre. Avant d'investir dans un outil ou un gros achat de bricolage, comparez toujours le prix affiché au prix habituel du produit ailleurs : une réduction annoncée n'est pas toujours calculée sur un prix de référence réel. Utilisez les boutons de tri ci-dessous pour classer les offres par plus grosse réduction ou par prix le plus bas, et parcourez les pages suivantes pour voir l'ensemble du catalogue bricolage en promotion.`,
  "jardin": `Outils de jardinage, mobilier extérieur, barbecues, arrosage, décoration extérieure... la catégorie jardin de RapidPromo rassemble les promotions du moment chez plusieurs marchands partenaires, pour équiper ou entretenir son extérieur sans payer le prix fort. Chaque fiche produit indique le prix le plus bas repéré, la réduction par rapport au prix de référence et la date de fin de l'offre lorsqu'elle est disponible. Les prix du jardin varient beaucoup selon la saison : mieux vaut comparer avant d'acheter, surtout en dehors du printemps où les vraies bonnes affaires se distinguent des simples déstockages. Triez les offres par réduction ou par prix, et naviguez entre les pages pour découvrir tout le catalogue jardin actuellement en promotion sur RapidPromo.`,
  "jeux-jouets": `Jeux de société, jouets pour enfants, figurines, jeux d'extérieur, jeux éducatifs... la catégorie jeux & jouets de RapidPromo compare les promotions repérées chez nos marchands partenaires, pour trouver une idée cadeau ou un jouet du quotidien au meilleur prix. Chaque fiche produit affiche le prix le plus bas actuel, la réduction appliquée et, si elle est connue, la date de fin de la promotion. Comme pour les autres catégories, une vigilance particulière est recommandée autour des fêtes de fin d'année, période où les prix barrés artificiellement gonflés sont les plus fréquents. Utilisez les boutons de tri pour classer les offres par réduction ou par prix, et parcourez les pages suivantes pour voir tout le catalogue jeux & jouets en promotion.`,
  "auto-moto": `Accessoires auto, entretien, équipement moto, GPS, sécurité routière... la catégorie auto & moto de RapidPromo réunit les meilleures promotions du moment chez plusieurs marchands partenaires. Chaque fiche produit indique le prix le plus bas repéré, la réduction par rapport au prix de référence et la date de fin de l'offre lorsqu'elle est renseignée. Pour l'équipement de sécurité (casques, gilets, sièges auto pour enfants notamment), vérifiez toujours les normes et certifications du produit en plus du prix avant d'acheter. Triez les offres ci-dessous par réduction ou par prix, et naviguez entre les pages pour voir l'ensemble du catalogue auto & moto actuellement en promotion.`,
  "animalerie": `Alimentation, accessoires, jouets et soins pour chiens, chats et autres animaux de compagnie... la catégorie animalerie de RapidPromo compare les promotions du moment chez nos marchands partenaires. Chaque fiche produit affiche le prix le plus bas actuel, la réduction appliquée par rapport au prix de référence et la date de fin de l'offre quand elle est disponible. Pour l'alimentation animale en particulier, comparez aussi le prix au kilo entre les formats avant de valider un achat en gros volume : une réduction en pourcentage peut cacher un prix au kilo moins avantageux qu'un format plus petit. Utilisez les boutons de tri pour classer les offres par réduction ou par prix, et parcourez les pages suivantes pour tout le catalogue animalerie en promotion.`,
  "bebe-puericulture": `Poussettes, sièges auto, alimentation bébé, jouets de premier âge, soins pour bébé... la catégorie bébé & puériculture de RapidPromo rassemble les promotions repérées chez plusieurs marchands partenaires. Chaque fiche produit indique le prix le plus bas du moment, la réduction par rapport au prix de référence et la date de fin de l'offre lorsqu'elle est connue. Pour les équipements de sécurité comme les sièges auto ou les lits, vérifiez systématiquement les normes en vigueur en plus du prix affiché. Triez les offres ci-dessous par réduction ou par prix, et parcourez les pages suivantes pour découvrir tout le catalogue bébé & puériculture actuellement en promotion.`,
  "sports-loisirs": `Équipement de fitness, vêtements de sport, vélos et accessoires, camping, loisirs créatifs... la catégorie sports & loisirs de RapidPromo réunit les meilleures promotions du moment chez nos marchands partenaires. Chaque fiche produit affiche le prix le plus bas repéré, la réduction appliquée par rapport au prix de référence et, quand elle est disponible, la date de fin de la promotion. Comparez le prix affiché au prix habituel du produit avant d'acheter, en particulier pour le gros équipement sportif où les écarts de prix entre enseignes peuvent être importants. Utilisez les boutons de tri pour classer les offres par réduction ou par prix, et parcourez les pages suivantes pour voir tout le catalogue sports & loisirs en promotion.`,
  "epicerie": `Produits alimentaires, boissons, épicerie fine, produits du quotidien... la catégorie épicerie de RapidPromo compare les promotions repérées chez plusieurs marchands partenaires. Chaque fiche produit indique le prix le plus bas actuellement disponible et la réduction appliquée par rapport au prix de référence, avec une date de fin d'offre quand elle est connue. Pour les produits alimentaires, pensez à vérifier la date de péremption indiquée sur la fiche marchand avant de commander en grande quantité, un prix attractif ne compensant pas un produit proche de sa date limite. Triez les offres ci-dessous par réduction ou par prix, et parcourez les pages suivantes pour voir tout le catalogue épicerie en promotion.`,
  "bureau": `Papeterie, fournitures scolaires, mobilier de bureau, imprimantes et consommables... la catégorie fournitures de bureau de RapidPromo réunit les promotions du moment chez nos marchands partenaires. Chaque fiche produit affiche le prix le plus bas repéré, la réduction par rapport au prix de référence et la date de fin de l'offre lorsqu'elle est disponible. La rentrée de septembre est la période où les prix bougent le plus sur cette catégorie : n'hésitez pas à comparer plusieurs fois avant d'acheter en volume pour toute une famille ou une entreprise. Utilisez les boutons de tri pour classer les offres par réduction ou par prix, et parcourez les pages suivantes pour tout le catalogue fournitures de bureau en promotion.`,
  "jeux-video": `Consoles, jeux, accessoires gaming, manettes, casques audio pour joueurs... la catégorie jeux vidéo de RapidPromo compare les promotions du moment chez plusieurs marchands partenaires. Chaque fiche produit indique le prix le plus bas actuel, la réduction appliquée par rapport au prix de référence et la date de fin de la promotion quand elle est connue. Les prix des jeux vidéo et des consoles varient fortement selon les périodes de soldes et les sorties concurrentes : comparez toujours avant d'acheter, y compris entre l'édition physique et l'édition dématérialisée d'un même jeu. Triez les offres ci-dessous par réduction ou par prix, et parcourez les pages suivantes pour découvrir tout le catalogue jeux vidéo en promotion.`,
};
